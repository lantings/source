...
def action_datax():
	...
	ScheduleType = '1'
	if ScheduleType == '1':
		#os.system("python /opt/datatom/datax/bin/datax.py -p \"-Dtimecolumn=%s\" /opt/datatom/dana_appendix_api/execute_cfg/gonganju_appendix_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.json > /opt/datatom/dana_appendix_api/log/${exec_datax_log}/gonganju_appendix_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.log"%addtime)
		os.system("python /opt/datatom/datax/bin/datax.py -p \"-Dtimecolumn=%s\" /opt/datatom/dana_appendix_api/execute_cfg/gonganju_appendix_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.json > /opt/datatom/dana_appendix_api/log/gonganju_appendix_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.log"%addtime)
		#sed_log('gonganju_appendix_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df')
		operate_tables('/opt/datatom/dana_appendix_api/log/gonganju_appendix_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.log', 'GONGANJU_TXT.BASE_SJKK_GCJL_ECJGH_DF_%s'%day_time, 'detuo_base.BASE_SJKK_GCJL_ECJGH_DF','detuo_base.job_run_info')
		pri.ok("table detuo_base.BASE_SJKK_GCJL_ECJGH_DF data extraction txt succeed，uploading to inceptor!")
	elif ScheduleType == '3':
		#os.system("python /opt/datatom/datax/bin/datax.py -p \"-Dtimecolumn=%s\" /opt/datatom/dana_appendix_api/execute_cfg/gonganju_appendix_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.json > /opt/datatom/dana_appendix_api/log/${exec_datax_log}/gonganju_appendix_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.log"%addtime)
		os.system("python /opt/datatom/datax/bin/datax.py -p \"-Dtimecolumn=%s\" /opt/datatom/dana_appendix_api/execute_cfg/gonganju_appendix_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.json > /opt/datatom/dana_appendix_api/log/gonganju_appendix_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.log"%addtime)
		#sed_log('gonganju_appendix_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df')
		operate_tables('/opt/datatom/dana_appendix_api/log/gonganju_appendix_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.log', 'GONGANJU_TXT.BASE_SJKK_GCJL_ECJGH_DF_%s'%month_time, 'detuo_base.BASE_SJKK_GCJL_ECJGH_DF','detuo_base.job_run_info')
		pri.ok("table detuo_base.BASE_SJKK_GCJL_ECJGH_DF data extraction txt succeed，uploading to inceptor!")
	else:
...
def upload():
	...
	if ScheduleType == '1':
		...
		if Type == '1':	
		#新建txt以及orc表
			txt_table = "create table if not exists GONGANJU_TXT.BASE_SJKK_GCJL_ECJGH_DF_%s(JLBH VARCHAR2(255) comment '记录编号',XZQH VARCHAR2(255) comment '行政区划',KKBH VARCHAR2(255) comment '卡口编号',CDBH VARCHAR2(255) comment '彻底哦啊编号',HPHM VARCHAR2(255) comment '号牌号码',HPZL BLOB comment '号牌种类',JGSJ VARCHAR2(255) comment '经过时间',SBBH VARCHAR2(255) comment '设备编号',CDFX VARCHAR2(255) comment '车道方向',XSZT VARCHAR2(255) comment '行驶状态',TPLX VARCHAR2(255) comment '图片类型',TZTP VARCHAR2(255) comment '特征图片',QJTP VARCHAR2(255) comment '全景图片',RKSJ VARCHAR2(255) comment '入库时间',YZSJ VARCHAR2(255) comment '验证时间',SJCZ VARCHAR2(255) comment '时间差值',SJLY VARCHAR2(255) comment '数据来源',DWD_LOADTIME VARCHAR2(255) comment 'DWD新增时间',DWD_UPDATETIME VARCHAR2(255) comment 'DWD更新时间',DWD_YXBZ VARCHAR2(255) comment '有效标志',DT TIMESTAMP comment '日期分区',JHPT_UPDATE_TIME TIMESTAMP comment '时间戳字段',JHPT_DELETE INT comment '删除标志字段')ROW FORMAT DELIMITED  FIELDS TERMINATED BY '\u0001';"%day_time
			orc_table = "create table if not exists GONGANJU_ODS.BASE_SJKK_GCJL_ECJGH_DF_%s(JLBH VARCHAR2(255) comment '记录编号',XZQH VARCHAR2(255) comment '行政区划',KKBH VARCHAR2(255) comment '卡口编号',CDBH VARCHAR2(255) comment '彻底哦啊编号',HPHM VARCHAR2(255) comment '号牌号码',HPZL BLOB comment '号牌种类',JGSJ VARCHAR2(255) comment '经过时间',SBBH VARCHAR2(255) comment '设备编号',CDFX VARCHAR2(255) comment '车道方向',XSZT VARCHAR2(255) comment '行驶状态',TPLX VARCHAR2(255) comment '图片类型',TZTP VARCHAR2(255) comment '特征图片',QJTP VARCHAR2(255) comment '全景图片',RKSJ VARCHAR2(255) comment '入库时间',YZSJ VARCHAR2(255) comment '验证时间',SJCZ VARCHAR2(255) comment '时间差值',SJLY VARCHAR2(255) comment '数据来源',DWD_LOADTIME VARCHAR2(255) comment 'DWD新增时间',DWD_UPDATETIME VARCHAR2(255) comment 'DWD更新时间',DWD_YXBZ VARCHAR2(255) comment '有效标志',DT TIMESTAMP comment '日期分区',JHPT_UPDATE_TIME TIMESTAMP comment '时间戳字段',JHPT_DELETE INT comment '删除标志字段') stored as hyperdrive;"%day_time
