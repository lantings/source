...
def action_datax():
	ScheduleType = '1'
	if ScheduleType == '1':
		#os.system("python /opt/datatom/datax/bin/datax.py -p \"-Dtimecolumn=%s\" /opt/datatom/dana_appendix_api/execute_cfg/huanbaoju_appendix_16_88_syrk_t_zp_edz_2.json > /opt/datatom/dana_appendix_api/log/${exec_datax_log}/huanbaoju_appendix_16_88_syrk_t_zp_edz_2.log"%addtime)
		os.system("python /opt/datatom/datax/bin/datax.py -p \"-Dtimecolumn=%s\" /opt/datatom/dana_appendix_api/execute_cfg/huanbaoju_appendix_16_88_syrk_t_zp_edz_2.json > /opt/datatom/dana_appendix_api/log/huanbaoju_appendix_16_88_syrk_t_zp_edz_2.log"%addtime)
