...
def action_datax():
	...
	ScheduleType = '1'
	if ScheduleType == '1':
		#os.system("python /opt/datatom/datax/bin/datax.py -p \"-Dtimecolumn=%s\" /opt/datatom/dana_appendix_api/execute_all/gonganju_ftp_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.json > /opt/datatom/dana_appendix_api/log/${exec_datax_log}/gonganju_ftp_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.log"%addtime)
		os.system("python /opt/datatom/datax/bin/datax.py -p \"-Dtimecolumn=%s\" /opt/datatom/dana_appendix_api/execute_all/gonganju_ftp_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.json > /opt/datatom/dana_appendix_api/log/gonganju_ftp_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.log"%addtime)
		#sed_log('gonganju_ftp_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df')
		operate_tables('/opt/datatom/dana_appendix_api/log/gonganju_ftp_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.log', 'GONGANJU_TXT.BASE_SJKK_GCJL_ECJGH_DF_%s'%day_time, 'detuo_base.BASE_SJKK_GCJL_ECJGH_DF','detuo_base.job_run_info')
		pri.ok("table detuo_base.BASE_SJKK_GCJL_ECJGH_DF data extraction txt succeed，uploading to inceptor!")
	elif ScheduleType == '3':
		#os.system("python /opt/datatom/datax/bin/datax.py -p \"-Dtimecolumn=%s\" /opt/datatom/dana_appendix_api/execute_all/gonganju_ftp_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.json > /opt/datatom/dana_appendix_api/log/${exec_datax_log}/gonganju_ftp_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.log"%addtime)
		os.system("python /opt/datatom/datax/bin/datax.py -p \"-Dtimecolumn=%s\" /opt/datatom/dana_appendix_api/execute_all/gonganju_ftp_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.json > /opt/datatom/dana_appendix_api/log/gonganju_ftp_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.log"%addtime)
		#sed_log('gonganju_ftp_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df')
		operate_tables('/opt/datatom/dana_appendix_api/log/gonganju_ftp_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.log', 'GONGANJU_TXT.BASE_SJKK_GCJL_ECJGH_DF_%s'%month_time, 'detuo_base.BASE_SJKK_GCJL_ECJGH_DF','detuo_base.job_run_info')
		pri.ok("table detuo_base.BASE_SJKK_GCJL_ECJGH_DF data extraction txt succeed，uploading to inceptor!")
	else:
