...
def action_datax():
	...
	ScheduleType = '1'
	if ScheduleType == '1':
		#os.system("python /opt/datatom/datax/bin/datax.py -p \"-Dtimecolumn=%s\" /opt/datatom/dana_appendix_api/execute_all/gonganju_appendix_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.json > /opt/datatom/dana_appendix_api/log/${exec_datax_log}/gonganju_appendix_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.log"%addtime)
		os.system("python /opt/datatom/datax/bin/datax.py -p \"-Dtimecolumn=%s\" /opt/datatom/dana_appendix_api/execute_all/gonganju_appendix_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.json > /opt/datatom/dana_appendix_api/log/gonganju_appendix_148_98_detuo_base_base_sjkk_gcjl_ecjgh_df.log"%addtime)
