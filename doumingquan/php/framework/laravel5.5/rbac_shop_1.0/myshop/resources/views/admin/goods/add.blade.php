              ...
              <form role="form" action="{{url('admin/goods')}}" method="post"  enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="goodsname" id="exampleInputPassword1" placeholder="请输入商品名称">
                  </div>
                  <div class="form-group">
                        <label>商品分类</label>
                        <select class="custom-select" name="cate_id">
                            ...
                            @foreach($data as $v)
                                @if ($v->size==0)
                                <option disabled value="{{$v->id}}">{{$v->catename}}</option>
                                @else
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" id="exampleInputPassword1" placeholder="请输入商品标题">
                  </div>
                  <div class="form-group">
                      <label for="exampleInputPassword1">商品价格</label>
                      <input type="text" class="form-control" name="price" id="exampleInputPassword1" placeholder="请输入商品标题">
                  </div>
                  <div class="form-group">
                      <label for="exampleInputPassword1">商品活动价格</label>
                      <input type="text" class="form-control" name="hdprice" id="exampleInputPassword1" placeholder="请输入商品标题">
                  </div>
                  <div class="form-group">
                        <label for="exampleInputPassword1">数量</label>
                        <input type="text" class="form-control" name="num" id="exampleInputPassword1" placeholder="请输入商品数量">
                  </div>
                  <div class="form-group">
