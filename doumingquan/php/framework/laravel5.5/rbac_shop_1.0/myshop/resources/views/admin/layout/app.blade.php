                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview ">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{url('/admin/cate')}}" class="nav-link active"><p>分类列表</p> </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{url('/admin/cate/create')}}" class="nav-link"><p>分类添加</p></a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item has-treeview ">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{url('/admin/carouse')}}" class="nav-link active"><p>轮播图列表</p> </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{url('/admin/carouse/create')}}" class="nav-link"><p>轮播图添加</p></a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{url('/admin/goods')}}" class="nav-link active"><p>商品列表</p> </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{url('/admin/goods/create')}}" class="nav-link"><p>商品添加</p></a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item has-treeview ">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{url('/admin/goods')}}" class="nav-link active"><p>管理员列表</p> </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{url('/admin/goods/create')}}" class="nav-link"><p>管理员添加</p></a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item has-treeview">
